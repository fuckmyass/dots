 ...
 *6)emptycol         */
static const char *colors[] = {"#81a2be","#c5c8c6","#f95168","#f95168","#f95168","#1d1f21","#0d131c"};
/*
...
///--Menus and Programs---///
static const char *lock[]     =  { "/home/shit-twins/bin/py3lock.py", NULL };
static const char *browser[]     =  { "firefox", NULL };
static const char *dmenu[]       =  { "/home/shit-twins/bin/dmenu_bind.sh", NULL};
...
static key keys[] = {
    ...
    {  MOD ,              XK_a,          start,             {.com = dmenu}},
    {  MOD |SHIFT,        XK_w,          start,             {.com = lock}},
...
static Button buttons[] = {
    ...
    {  MOD|CONTROL,XCB_BUTTON_INDEX_3,     start,         {.com = lock}},
    {  Mod1,       XCB_BUTTON_INDEX_1,     start,         {.com = dmenu}},
